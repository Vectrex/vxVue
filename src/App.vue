  ...
  <div class="grid grid-cols-1 gap-4 px-4 pt-28 mx-auto md:pt-32 lg:grid-cols-2 2xl:grid-cols-3">
    ...
    <div class="p-4 space-y-2 shadow-md">
      ...
      <div class="flex justify-between space-x-2">
        <submit-button class="py-2 px-4 font-medium text-white rounded focus:ring-2 focus:ring-offset-2 focus:outline-none bg-vxvue hover:bg-vxvue-700 focus:ring-vxvue" @submit="doSubmit" :busy="submitBusy">A default submit button</submit-button>
        <submit-button class="py-2 px-4 font-medium rounded focus:ring-2 focus:ring-offset-2 focus:outline-none" @submit="doSubmit" :busy="submitBusy" theme="success">Submit button 'success'</submit-button>
        <submit-button class="py-2 px-4 font-medium rounded focus:ring-2 focus:ring-offset-2 focus:outline-none" @submit="doSubmit" :busy="submitBusy" theme="error">Submit button 'error'</submit-button>
      </div>
    </div>
